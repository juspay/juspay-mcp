...
JUSPAY_DASHBOARD_IGNORE_TOOL = json.loads(os.getenv('DASHBOARD_TOOL_IGNORE_LIST', '["juspay_list_configured_gateway","juspay_get_gateway_scheme","juspay_get_gateway_details","juspay_list_gateway_scheme","juspay_get_merchant_gateways_pm_details","juspay_report_details","juspay_list_report","juspay_alert_details","juspay_list_alerts","q_api"]'))
