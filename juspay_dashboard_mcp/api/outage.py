...
async def list_outages_juspay(payload: dict) -> dict:
    """
    Returns a list of outages within a specified time range, optionally filtered by merchant ID.

    The API endpoint is:
        https://portal.juspay.in/api/ec/v1/admin/outage/list
    ...
    Returns:
        dict: The parsed JSON response from the Juspay List Outages API containing:
            ...
            - outagePeriods: Array of outage periods with startTime, endTime, and duration
